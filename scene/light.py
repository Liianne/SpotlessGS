...
class LightBaseLie(nn.Module):
    ...
    def __init__(self, t_x: float = 0.145, t_y: float = 0.03, t_z: float = 0.08, r_x: float = 0.0, r_y: float = 0.0, r_z: float = 0.0, relit: bool = False) -> None:
        super().__init__()
        ...
        # x+: light is right to camera, y+: light is below the camera; z+: light is in front of camera

...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, load_iteration=None, shuffle=True, resolution_scales=[1.0]):
        ...
        if shuffle:
            ...
            # random.shuffle(scene_info.novel_cameras)  # Multi-res consistent random shuffling
        ...
        if self.loaded_iter:
            ...
            if scene_info.point_cloud is None:
                print("DEBUG: scene_info.point_cloud =", scene_info.point_cloud)
                raise ValueError("The point cloud is None. Check if it's loaded properly.")
            else:
                print("Point cloud loaded correctly")

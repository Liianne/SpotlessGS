...
def readColmapSceneInfo(path, images, eval, llffhold=11):
    try:
        ...
        cameras_extrinsic_test_file = os.path.join(path, "sparse/0", "images_test.bin")
        cameras_intrinsic_file = os.path.join(path, "sparse/0", "cameras.bin")
        cam_extrinsics = read_extrinsics_binary(cameras_extrinsic_file)
        cam_extrinsics_test = read_extrinsics_binary(cameras_extrinsic_test_file)
        cam_intrinsics = read_intrinsics_binary(cameras_intrinsic_file)
    except:
        cameras_extrinsic_file = os.path.join(path, "sparse/0", "images.txt")
        cameras_extrinsic_test_file = os.path.join(path, "sparse/0", "images_test.txt")
        cameras_intrinsic_file = os.path.join(path, "sparse/0", "cameras.txt")
        cam_extrinsics = read_extrinsics_text(cameras_extrinsic_file)
        cam_extrinsics_test = read_extrinsics_text(cameras_extrinsic_test_file)
    ...
    cam_infos_unsorted_test = readColmapCameras(cam_extrinsics=cam_extrinsics_test, cam_intrinsics=cam_intrinsics, images_folder=os.path.join(path, reading_dir))
    ...
    #ply_path = os.path.join(path, "sparse/0/fused_colored_cloud_with_normals.ply")
    #ply_path = os.path.join(path, "sparse/0/points3D_with_normals.ply")
    #ply_path = os.path.join(path, "/home/stud/hlia/storage/master_thesis/okvis2/records/new_okvis/17-12-2025-19-46-31/colmap_okvis_2/sparse/0/points3D_with_normals.ply")
    #ply_path = os.path.join(path, "sparse/0/points3D.ply")
    ply_path = os.path.join(path, "sparse/0/points3D_normals_okvis.ply")
    #ply_path = os.path.join(path, "sparse/0/points3D_normals.ply")

    #ply_path = os.path.join(path, "sparse/0/he_sub_fused_colored_cloud_with_normals.ply")
    
    #ply_path = os.path.join(path, "sparse/0/points3D_with_normals_filtered.ply")
    #ply_path = os.path.join(path, "sparse/0/filtered_he_sub_fused_colored_cloud_with_normals.ply")
    #ply_path = os.path.join(path,"filtered_points3D_with_normals.ply")
    #ply_path = "/home/stud/hlia/storage/master_thesis/ori_ori_darkgs/darkgs/output/71ee52dd-d/point_cloud/iteration_7000/point_cloud.ply"
    #ply_path = os.path.join(path, "sparse/0/points3D.ply")
    #ply_path = os.path.join(path, "sparse/0/points3D_color_with_normal.ply")
    #ply_path = os.path.join(path, "sparse/0/okvis_normals.ply")
...
def readNerfSyntheticInfo(path, white_background, eval, extension=".png"):
    ...
    #ply_path = os.path.join(path, "sub_pointcloud_with_normals.ply")
